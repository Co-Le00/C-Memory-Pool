...
extern "C" memory_pool_t * API create_memory_pool  (unsigned int type, unsigned int number_of_blocks)
{
...
extern "C" void   API delete_memory_pool  (memory_pool_t * memory_pool)
{
	#if DEBUG_MODE
...
extern "C" void * API allocate_memory_pool(memory_pool_t * memory_pool)
{
...
extern "C" void API deallocate_memory_pool (memory_pool_t * memory_pool, void * memory_address)
{
